...
class SpinViewCaptureMode:
    ...
    def _select_camera_region(self):
        ...
        if mode == "rectangle":
            from DIC.ui.live_analyze.camera_region_selectors import CameraRegionSelector
            ...
            from DIC.ui.live_analyze.camera_region_selectors import CameraPolygonSelector
