    ...
    def test_multiple_methods_fixed(self, gray):
        ...
        for percentile in fine_percentiles:
            try:
                ...
                _, binary_percentile = cv2.threshold(gray, thresh_val, 255, cv2.THRESH_BINARY_INV)
        ...
        try:
            ...
            for offset in [-10, -5, 0, 5, 10]:
                ...
                adjusted_thresh = max(0, min(255, otsu_thresh + offset))
        ...
        try:
            ...
            for gap_sensitivity in [5, 10, 15, 20]:
                high_thresh = otsu_thresh + gap_sensitivity
                low_thresh = otsu_thresh - gap_sensitivity
...
if __name__ == "__main__":
    ...
    print("• ✅ Missing apply_fixed_size_filtering method added")
